...
STDMETHODIMP CPlace::InterfaceSupportsErrorInfo(REFIID riid)
{
...
//IPlace
STDMETHODIMP CPlace::setPosition( IGeoPoint * pIGeoPoint )
{
...
STDMETHODIMP CPlace::getPosition( IGeoPoint ** pIGeoPoint )
{
...
STDMETHODIMP CPlace::setText( BSTR strText )
{
...
STDMETHODIMP CPlace::getText( BSTR * pStrText )
{
...
STDMETHODIMP CPlace::setImageSrc( BSTR strImageSrc )
{
	getOrCreateInnerObject()->setImageSrc( CStringA( strImageSrc ).GetString() );
	return S_OK;
}